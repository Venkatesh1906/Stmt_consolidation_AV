...
# o.Visible = False
# input_dir = r"..\Data\OneDrive_3_10-13-2021"
# output_dir = r"..\Data\OneDrive_3_10-13-2021_xlsx"
...
# File Consolidation
dir_to_read = r'..\Data\OneDrive_4_10-13-2021_xlsx'
...
# Removing the single text - Deutsche Bank Aktiengesellschaft (Incorporated in the Federal Republic of Germany & members’ liability is limited)
full_txns_df.replace("Deutsche Bank Aktiengesellschaft (Incorporated in the Federal Republic of Germany & members’ liability is limited)",
                     np.nan,
                     inplace=True)
...
# File Consolidation
dir_to_read = r'..\Data\OneDrive_3_10-13-2021_xlsx'
file_names = os.listdir(dir_to_read)
...
full_pos_df.replace("Deutsche Bank Aktiengesellschaft (Incorporated in the Federal Republic of Germany & members’ liability is limited)",
                    np.nan,
                    inplace=True
                    )
